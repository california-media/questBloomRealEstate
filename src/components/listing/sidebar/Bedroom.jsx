...
const Bedroom = ({ setBedroomCount, bedroomCount}) => {
  const bedOptions = [
    { id: "sxany", label: "any", value: 0 },
    { id: "sxoneplus", label: "1+", value: 1 },
    { id: "sxtwoplus", label: "2+", value: 2 },
    { id: "sxthreeplus", label: "3+", value: 3 },
    { id: "sxfourplus", label: "4+", value: 4 },
    { id: "sxfiveplus", label: "5+", value: 5 },
  ];
