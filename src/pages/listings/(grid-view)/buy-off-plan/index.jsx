...
const BuyOffplan3Col = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await adminApi.get("/pages/buy-off-plan/sections");
    ...
    <>
      ...
      <section
        ...
        dangerouslySetInnerHTML={{
          __html:
            sections.find(
              (section) => section.section_name === "Buy and Off-plan Header"
            )?.html_content ||
            `<div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="breadcumb-style1">
                <h2 class="title">Off-plan and Resale Properties</h2>
