...
import ProperteyFilteringCommercial from "@/components/listing/grid-view/grid-full-3-col/ProperteyFilteringCommercial";
...
const metaInformation = {
  title: "Quest Bloom Real Estate LLC | Buy",
};
    ...
    <>
      ...
      <section
        ...
        dangerouslySetInnerHTML={{
          __html:
            sections.find((section) => section.section_name === "Commercial Header")
              ?.html_content ||
            `<div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="breadcumb-style1">
                <h2 class="title">Commercial Properties for Sale (UAE)</h2>
